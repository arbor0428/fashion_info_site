...
<div style='width:100%;height:50px;border-bottom:1px solid #d1d1d1;'>
		<div class="sidebar">
			...
			<div class="sbfirst" style='width:140px;height:50px;line-height:50px;padding-left:20px;color:#666666;float:left;border-left:1px solid #d1d1d1;'>학사안내</div>
			<div style='width:290px; height:50px;line-height:50px;padding-left:20px;color:#666666;float:left;border-left:1px solid #d1d1d1;'>자료실</div>
