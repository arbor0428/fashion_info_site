...
.pageNum .this,.pageNum a,.pageNum strong{position:relative; display:inline-block;width:40px; height:40px; line-height:40px;margin:0 5px; font-family: 'ONE-Mobile-Title'; font-weight: bold; font-size:16px;}
.pageNum a{color:#231815; text-decoration:none!important;}
.pageNum .direction .lnr {font-weight: bold; font-size:16px;}
